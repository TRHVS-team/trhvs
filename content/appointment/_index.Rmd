...
# Fjarfundir vegna COVID-19

```{r}
blogdown::shortcode("boka_fjarfundur")
```

Vegna COVID faraldurs eru öll viðtöl okkar á formi fjarfunda. Bókið tíma og við munum senda fundarboð í Microsoft Teams. 

[Hér má sjá teams ráð í boði Upplýsingatækvisviðs](https://uts.hi.is/teams_fjarfundir)
